...
#         cv = joblib.load('coutvectorizer.joblib')
...
#         model_xgb2 = load_model("urgency_classifier.joblib")
...
#         result_str = cv.transform(final_result)
#         result_str = tfidf_transformer.transform(result_str)
...
#         model2_train = (sum(predictions)/ len(predictions))
